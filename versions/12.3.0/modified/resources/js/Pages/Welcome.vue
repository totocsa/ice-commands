    ...
    <IceLayout title="Users" :authUser="$page.props.auth.user">
        <template #header>
            <ControllerMenu v-if="$page.props.auth.user" :userRoles="props.userRoles" groupName="default" active="root">
                ...
                <Link :href="route('profile.show')" :class="controllerMenuLink">
            ...
            <ControllerMenu v-else :userRoles="props.userRoles" groupName="default" active="root">
                ...
                <Link v-if="canRegister" :href="route('register')" :class="controllerMenuLink">
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                    ...
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            ...
                                            <p class="mt-4 text-sm/relaxed">
                                                ...
                                                framework. Whether you are
                                                a newcomer or have prior experience with Laravel, we recommend
                            ...
                            <a href="https://laracasts.com"
                                ...
                                <div class="pt-3 sm:pt-5">
                                    ...
                                    <p class="mt-4 text-sm/relaxed">
                                        ...
                                        them out, see for yourself, and massively level up your development skills
                                        in the process.
                                    </p>
                                </div>
                            ...
                            <div
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Vibrant Ecosystem
                                    </h2>
